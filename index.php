        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-7">
              <h1 class="text-white">Smart Crop Management System</h1>
              <p class="text-white">
               Your Smart Farming Assistant - Making Agriculture Smarter
              </p>
              <div class="cg">
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em
                        ><b
                          > "Innovation in agriculture is the key to feeding our growing world sustainably."</b
                        ></em
                      >
                    </h6>
                    <br />
                    ...
                    <footer class="blockquote-footer vg text-dark">
                      Ayush's Smart Farming Initiative
                    </footer>
                  </blockquote>
                </div>
              </div>
