        ...
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    <div class="btn-group text-center" role="group">
                        <a role="button" class="btn btn-primary" href="tel:+91-9008470308"><i class="fa fa-phone"></i> Call</a>
                        <a role="button" class="btn btn-info" href="tel:+91XXXXXXXXXX"> <i class="fa fa-fax"></i> Fax</a>
                        <a role="button" class="btn btn-success" href="mailto:ayushkumar200326@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                    </div>
                </div>				
